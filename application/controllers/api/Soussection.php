...
class Soussection extends REST_Controller {

    public function __construct() {
        parent::__construct();
        $this->load->model('soussection_model', 'ProduitManager');
    ...
    public function index_get() {
		...
		if ($id) {
            ...
            $data['id_section'] = $prd->id_section;
            $data['ponderation'] = $prd->ponderation;
        ...
        if ($supprimer == 0) {
            if ($id == 0) {
                $data = array(
                    ...
                    'ponderation' => intval($this->post('ponderation')),
